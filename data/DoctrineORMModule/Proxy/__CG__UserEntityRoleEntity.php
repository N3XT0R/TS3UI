 ...
 */
class RoleEntity extends \User\Entity\RoleEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'roleID', 'rolename');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RoleEntity $proxy) {
    ...
    public function setRolename($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRolename', array($name));
